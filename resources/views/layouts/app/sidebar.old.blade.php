            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:sidebar.group icon="cog-6-tooth"  heading="{{ __('Settings') }}" class="grid">
                        ...
                        <flux:sidebar.item icon="adjustments-horizontal" :href="route('modules.index')" :current="request()->routeIs('modules.index')">{{ __('Modules') }}</flux:sidebar.item>
                    ...
                    <flux:sidebar.group icon="document-text"  heading="{{ __('Anagraphic')}}" class="grid">
                        ...
                        <flux:sidebar.item icon="building-office" :href="route('company.index')" :current="request()->routeIs('company.index')">{{ __('Company') }}</flux:sidebar.item>
                    </flux:sidebar.group>
