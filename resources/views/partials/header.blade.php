                        ...
                        <div class="row">
                            ...
                            <div class="col d-flex">
                                <a href="form_inputs.html" class="related-app">
                                    ...
                                    <span class="mt-1 source-title">Forms</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                    <div class="p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0);"><span class="badge bg-info-transparent" id="cart-data">5 Items</span></a>
                        </div>
                    </div>
                    ...
                    <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                        <li class="dropdown-item p-3 border-bottom">
                            <div class="d-flex align-items-center cart-dropdown-item">
                                <div>
                                    <img src="../assets/images/ecommerce/1.jpg" alt="img" class="avatar avatar-lg me-2">
                                </div>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark w-75">
                                            <a href="cart.html">TrueBasket Metal Single Pot</a>
                                        </div>
                                        <div>
                                    ...
                                    <div class="text-muted fs-12">
                                        <span class="fw-normal">Status: <span class="text-primary">In Stock</span></span>
                        ...
                        <li class="dropdown-item p-3 border-bottom">
                            <div class="d-flex align-items-center cart-dropdown-item">
                                <div>
                                    <img src="../assets/images/ecommerce/2.jpg" alt="img" class="avatar avatar-lg me-2">
                                </div>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark w-75">
                                            <a href="cart.html">Authentic chair with Canopy</a>
                                        </div>
                                        <div>
                        ...
                        <li class="dropdown-item p-3 border-bottom">
                            <div class="d-flex align-items-center cart-dropdown-item">
                                <div>
                                    <img src="../assets/images/ecommerce/3.jpg" alt="img" class="avatar avatar-lg me-2">
                                </div>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark w-75">
                        ...
                        <li class="dropdown-item p-3 border-bottom">
                            <div class="d-flex align-items-center cart-dropdown-item">
                                <div>
                                    <img src="../assets/images/ecommerce/4.jpg" alt="img" class="avatar avatar-lg me-2">
                                </div>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark w-75">
                                    ...
                                    <div class="text-muted fs-12">
                                        <span class="fw-normal">Status: <span class="text-danger">Out of Stock</span></span>
                                        <p class="mb-0 fw-normal text-gray">Quantity: 01
                                            <a aria-label="anchor" href="javascript:void(0);" class="header-cart-remove float-end dropdown-item-close"><i class="ti ti-trash"></i></a>
                                        </p>
                                    </div>
                        ...
                        <li class="dropdown-item p-3">
                            <div class="d-flex align-items-center cart-dropdown-item">
                                <div>
                                    <img src="../assets/images/ecommerce/5.jpg" alt="img" class="avatar avatar-lg me-2">
                                </div>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark w-75">
                                            <a href="cart.html">camera lens (16mm f/1.4)</a>
                                        </div>
                                        <div>
                    ...
                    <div class="py-5 px-4 empty-item d-none">
                        <div class="text-center">
                            ...
                            <span class="mb-3 fw-normal fs-13 d-block">Looks like you haven't added anything yet...<i class="fa fa-smile"></i></span>
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <div class="me-sm-2 me-0">
                            <img src="../assets/images/faces/6.jpg" alt="img" width="32" height="32" class="rounded-circle">
                        </div>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="dropdown-item dropdown-hover d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" class="profile-icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
