...
<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <a href="index.html" class="header-logo">
            <img src="../assets/images/brand-logos/logo.png" alt="Bookygo" class="desktop-logo">
        </a>
    </div>
    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide__category"><span class="category-name">TEST</span></li>
                @foreach($menuModules as $module)
                <li class="slide">
                    <a href="{{ route($module->route) }}" class="side-menu__item">
                       <img src="{{ asset('assets/svg/' . $module->route_icon) }}" alt="icon" class="side-menu__icon pr-4" width="24px" height="24px">
                        <span class="side-menu__label">{{ $module->title }}</span>
                    </a>
                </li>
                @endforeach
                ...
                <li class="slide">
                   ...
                   <li class="slide">
                    <a href="{{route('permissions.index')}}" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Permessi</span>
                    </a>
                </li>
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                            <path d="M21.5,21h-19C2.223877,21,2,21.223877,2,21.5S2.223877,22,2.5,22h19c0.276123,0,0.5-0.223877,0.5-0.5S21.776123,21,21.5,21z M4.5,18.0888672h5c0.1326294,0,0.2597656-0.0527344,0.3534546-0.1465454l10-10c0.000061,0,0.0001221-0.000061,0.0001831-0.0001221c0.1951294-0.1952515,0.1950684-0.5117188-0.0001831-0.7068481l-5-5c0-0.000061-0.000061-0.0001221-0.0001221-0.0001221c-0.1951904-0.1951904-0.5117188-0.1951294-0.7068481,0.0001221l-10,10C4.0526733,12.3291016,4,12.4562378,4,12.5888672v5c0,0.0001831,0,0.0003662,0,0.0005493C4.0001831,17.8654175,4.223999,18.0890503,4.5,18.0888672z M14.5,3.2958984l4.2930298,4.2929688l-2.121582,2.121582l-4.2926025-4.293396L14.5,3.2958984z M5,12.7958984l6.671814-6.671814l4.2926025,4.293396l-6.6713867,6.6713867H5V12.7958984z"></path>
                        </svg>
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                            <path d="M19,2H9C7.3438721,2.0018311,6.0018311,3.3438721,6,5v1H5C3.3438721,6.0018311,2.0018311,7.3438721,2,9v10c0.0018311,1.6561279,1.3438721,2.9981689,3,3h10c1.6561279-0.0018311,2.9981689-1.3438721,3-3v-1h1c1.6561279-0.0018311,2.9981689-1.3438721,3-3V5C21.9981689,3.3438721,20.6561279,2.0018311,19,2z M17,19c-0.0014038,1.1040039-0.8959961,1.9985962-2,2H5c-1.1040039-0.0014038-1.9985962-0.8959961-2-2v-8h14V19z M17,10H3V9c0.0014038-1.1040039,0.8959961-1.9985962,2-2h10c1.1040039,0.0014038,1.9985962,0.8959961,2,2V10z M21,15c-0.0014038,1.1040039-0.8959961,1.9985962-2,2h-1V9c-0.0008545-0.7719116-0.3010864-1.4684448-0.7803345-2H21V15z M21,6H7V5c0.0014038-1.1040039,0.8959961-1.9985962,2-2h10c1.1040039,0.0014038,1.9985962,0.8959961,2,2V6z"></path>
                        </svg>
                ...
                <li class="slide">
                    <a href="landing.html" target="_blank" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Landing<span class="badge bg-secondary rounded-pill float-end">new</span></span>
                    </a>
                </li>
                <!-- End::slide -->
                ...
                <!-- Start::slide__category -->
                <li class="slide__category"><span class="category-name">Submenu's</span></li>
                <!-- End::slide__category -->
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Sub Menu</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                        ...
                        <li class="slide">
                            <a href="javascript:void(0);" class="side-menu__item">Sub Menu-1</a>
                        </li>
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">Sub Menu-2
                                <i class="fe fe-chevron-right side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="javascript:void(0);" class="side-menu__item">Sub Menu-2-1</a>
                                </li>
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Sub Menu-2-2
                                        <i class="fe fe-chevron-right side-menu__angle"></i></a>
                                    <ul class="slide-menu child3">
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">Sub Menu-2-2-1</a>
                                        </li>
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">Sub Menu-2-2-2</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="products-add.html" class="side-menu__item">Add Products</a>
                                </li>
                                <li class="slide">
                                ...
                                <li class="slide">
                                    <a href="product-edit.html" class="side-menu__item">Edit Products</a>
                                </li>
                                <li class="slide">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="files.html" class="side-menu__item">Files</a>
                                </li>
                                <li class="slide">
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">E-mail
                                <i class="fe fe-chevron-right side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="mail-inbox.html" class="side-menu__item">Inbox</a>
                                </li>
                                <li class="slide">
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">Invoices
                                <i class="fe fe-chevron-right side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide">
                                ...
                                <li class="slide">
                                    <a href="invoice-timelog.html" class="side-menu__item">Time Log Invoice</a>
                                </li>
                                <li class="slide">
                                    <a href="invoice-edit.html" class="side-menu__item">Edit Invoice</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="projects.html" class="side-menu__item">Projects</a>
                                </li>
                                <li class="slide">
                                    <a href="projects-list.html" class="side-menu__item">Projects List</a>
                                </li>
                                <li class="slide">
                                    <a href="project-details.html" class="side-menu__item">Project Details</a>
                                </li>
                                <li class="slide">
                                    <a href="project-new.html" class="side-menu__item">Project New</a>
                                </li>
                                <li class="slide">
                                    <a href="project-edit.html" class="side-menu__item">Edit Project</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a href="ticket-details.html" class="side-menu__item">Tickets</a>
                        </li>
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">Tasks
                                <i class="fe fe-chevron-right side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="tasks-list.html" class="side-menu__item">Task List</a>
                                </li>
                                <li class="slide">
                                    <a href="task-edit.html" class="side-menu__item">Edit Task</a>
                                </li>
                                <li class="slide">
                                    <a href="task-create.html" class="side-menu__item">Create Task</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">Clients
                                <i class="fe fe-chevron-right side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="clients.html" class="side-menu__item">Clients</a>
                                </li>
                                <li class="slide">
                                    <a href="client-create.html" class="side-menu__item">Add Client</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="blog-edit.html" class="side-menu__item">Edit Post</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="401.html" class="side-menu__item">401 - Error</a>
                                </li>
                                <li class="slide">
